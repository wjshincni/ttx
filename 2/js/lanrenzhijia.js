...
ge1doot.Pointer = function (setup) {
	...
	// ===== [修复1] 全局阻止滚动：改为 addEventListener + passive:false =====
	...
	// ===== [修复2] Canvas 触摸事件：全部改为 addEventListener + passive:false =====
	if ('ontouchstart' in window) {
		...
		this.elem.addEventListener('touchcancel', function (e) { 
	...
	// ===== [修复3] gesturechange 加 passive:false =====
	...
	// mousewheel 事件也改为 addEventListener 防止被动警告
	this.elem.addEventListener('mousewheel', function (event) {
