...
document.querySelectorAll(".corse>input").forEach(function(input){
    input.onclick = function(){
      result(this.value)       
      document.querySelector("[for="+this.id+"]").style.boxShadow = "inset 0 0 0 100px lightblue"
    }
})
function showResult(winner){      
    switch(winner){
        ...
        case "computer":
            ...
            spanCountComputer.style.backgroundColor = "red"
            spanCountComputer.style.boxShadow = "0 0 10px 10px red"
            spanCountComputer.style.transform = "scale(1.1)"
        break            
        default:
            human.style.opacity = 1
            computer.style.opacity = 1
            spanCountComputer.style.backgroundColor = "yellow"
            spanCountHuman.style.backgroundColor = "yellow"
